...
$sql = "Select * from   tb_od_onlineProgram where 1 order by progromLevel ASC ";
...
<div id="content">
    <div id="content-header">
        ...
        <h1>Online Program Description Listing</h1>
    </div>
    <div class="container-fluid">
        <hr>
        <div class="row-fluid text-right"><button class="btn btn-primary"
                onclick="document.location.href = '/OnlineProgromDesc.php'"><a href="<?php echo '/OnlineProgromDesc.php.php?action=add&v='.rand(1000000000,100000000000)?>"
                    style="color:#fff">Add Online Program</a></button></div>
...
(programname ,progromLevel, titleDescription,longdescription,status,language)
                            <tr class="gradeX">
                                ...
                                <td><strong><?php echo $row['titleDescription']; ?></strong></td>
                                <td><strong><?php echo $row['progromLevel']; ?></strong></td>
                                <?php 
                                 $node_id = $row['onlineProgramid'];
                                        if ($row['status'] == 1) {
                                      echo       $output = '<td id="published' . $node_id . '"> <div class="onoffswitch">
        <input type="checkbox" autocomplete="off" name="onoffswitch" class="onoffswitch-checkbox" id="myonoffswitch' . $node_id . '" checked onclick="updateBudgetitemStatus(\'' . '' . 'function.php?&tbl=tb_od_onlineProgram&id=' . $node_id . '\')">
        <label class="onoffswitch-label" for="myonoffswitch' . $node_id . '">
            ...
            <span class="onoffswitch-switch"></span>
                                      ...
                                      echo       $output = '<td id="published' . $node_id . '"> <div class="onoffswitch">
        <input type="checkbox" autocomplete="off" name="onoffswitch" class="onoffswitch-checkbox" id="myonoffswitch' . $node_id . '" onclick="updateBudgetitemStatus(\'' . '' . 'function.php?&tbl=tb_od_onlineProgram&id=' . $node_id . '\')">
        <label class="onoffswitch-label" for="myonoffswitch' . $node_id . '">
            <span class="onoffswitch-inner"></span>
            <span class="onoffswitch-switch"></span>
        </label>
                                ...
                                <td class="center">
                                    <div class="btn-group"><button
                                            class="btn "><a href='<?php echo 'OnlineProgromDesc.php?action=edit&id='.$node_id?>'> Edit <a> <span
                                                ></span></button>
                                            <li><a href='<?php echo 'OnlineProgromDesc.php?action=edit&id='.$node_id?>'>Edit</a></li>
                                       </div>
                                </td>
                            </tr>
                            </tbody>
                        ...
                        $sql1 = "SELECT COUNT(*) FROM tb_od_onlineProgram";   
...
$num_results_on_page = 10;
      ?>
                        ...
                        <ul class="pagination">
                            <?php if ($page > 1): ?>
                            <li class="prev"><a href="onlineProgromList.php?page=<?php echo $page-1 ?>">Prev</a></li>
                            <?php endif; ?>

                            <?php if ($page > 3): ?>
                            <li class="start"><a href="onlineProgromList.php?page=1">1</a></li>
                            <li class="dots">...</li>
                            <?php endif; ?>

                            <?php if ($page-2 > 0): ?><li class="page"><a
                                    href="onlineProgromList.php?page=<?php echo $page-2 ?>"><?php echo $page-2 ?></a></li>
                            <?php endif; ?>
                  ...
                  onlineProgromListonlineProgromListonlineProgromListonlineProgromList          <?php if ($page+1 < ceil($total_pages / $num_results_on_page)+1): ?><li class="page"><a
                            ...
                            <li class="dots">...</li>
                            <li class="end"><a
                                    href="onlineProgromList.php?page=<?php echo ceil($total_pages / $num_results_on_page) ?>"><?php echo ceil($total_pages / $num_results_on_page) ?></a>
                            </li>
                            <?php endif; ?>

                            <?php if ($page < ceil($total_pages / $num_results_on_page)): ?>
                            <li class="next"><a href="onlineProgromList.php?page=<?php echo $page+1 ?>">Next</a></li>
                            <?php endif; ?>
                        </ul>
                        <?php endif; ?>
